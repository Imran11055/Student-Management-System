...
const c1 = new subj("py", "Python", 50000)
const c2 = new subj("ts", "Typescript", 45000)
const c3 = new subj("wd", "Web Develpment", 300000)
const c4 = new subj("cs", "Cyber Security", 150000)
const c5 = new subj("ml", "Machine Learning", 200000)
const c6 = new subj("web", "Web 3.0", 120000)
 
const Student1 = new studentData("Ali")
const Student2 = new studentData("Hassan")
const Student3 = new studentData("Hussain")
const Student4 = new studentData("Abbas")
const Student5 = new studentData("Hadi")
